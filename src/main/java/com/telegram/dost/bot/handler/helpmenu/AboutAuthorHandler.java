...
@Component
public class AboutAuthorHandler implements ReplyMessageHandler {
    ...
    @Autowired
    public AboutAuthorHandler(UserDataCache userDataCache,
                              @Qualifier("aboutAuthorReplyService") ReplyService replyService){
