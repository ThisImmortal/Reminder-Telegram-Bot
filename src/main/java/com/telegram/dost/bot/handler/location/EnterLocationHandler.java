package com.telegram.dost.bot.handler.location;
...
@Component
public class EnterLocationHandler implements ReplyMessageHandler {

    private UserDataCache userDataCache;
    private ReplyService replyService;

    @Autowired
    public EnterLocationHandler(UserDataCache userDataCache,
                                @Qualifier("enterLocationReplyService") ReplyService replyService){
    ...
    public SendMessage createReplyMessage(Update update) {
        ...
        userDataCache.setUsersCurrentBotState(userId, BotState.REMINDER_MENU);
    ...
    public BotState getMessageServiceName() {
        return BotState.ENTER_LOCATION;
    }
}
