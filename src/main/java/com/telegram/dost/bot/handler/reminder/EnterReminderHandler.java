...
@Component
public class EnterReminderHandler implements ReplyMessageHandler {
    ...
    @Autowired
    public EnterReminderHandler(UserDataCache userDataCache,
                                @Qualifier("enterReminderReplyService") ReplyService replyService){
    ...
    public BotState getMessageServiceName() {
        return BotState.ENTER_REMINDER_WITH_SUCH_FORMAT;
    }
}
