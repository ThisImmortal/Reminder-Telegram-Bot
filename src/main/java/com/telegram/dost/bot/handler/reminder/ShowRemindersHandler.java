...
@Component
public class ShowRemindersHandler implements ReplyMessageHandler {
    ...
    @Autowired
    public ShowRemindersHandler(UserDataCache userDataCache,
                                @Qualifier("showReminderReplyService") ReplyService replyService){
    ...
    public BotState getMessageServiceName() {
        return BotState.SHOW_MY_REMINDERS;
    }
}
